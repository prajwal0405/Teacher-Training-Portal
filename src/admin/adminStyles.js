...
export const AR_OVERLAY = {
  position: "fixed", inset: 0, background: "rgba(0,0,0,0.45)",
  display: "flex", alignItems: "center", justifyContent: "center",
  zIndex: 1000, backdropFilter: "blur(3px)", padding: 20,
};
export const AR_MODAL = {
...
export const AR_CLOSE = {
  background: "#f3f4f6", border: "none", width: 30, height: 30,
  borderRadius: 8, cursor: "pointer", fontSize: 15,
};
export const AR_BTN_PRIMARY = {
  padding: "8px 16px", borderRadius: 9, border: "none",
  background: "#f59e0b", color: "white", fontSize: 12,
  fontWeight: 700, cursor: "pointer", fontFamily: "inherit",
};
export const AR_BTN_GHOST = {
  padding: "7px 13px", borderRadius: 8,
  border: "1.5px solid #e5e7eb", background: "white",
  color: "#6b7280", fontSize: 12, fontWeight: 600,
  cursor: "pointer", fontFamily: "inherit",
...
export const NT_OVERLAY = {
  position:"fixed", inset:0, background:"rgba(0,0,0,0.45)",
  display:"flex", alignItems:"center", justifyContent:"center",
  zIndex:1000, backdropFilter:"blur(3px)", padding:20,
};
export const NT_MODAL = {
...
export const NT_CLOSE = {
  background:"#f3f4f6", border:"none", width:30, height:30,
  borderRadius:8, cursor:"pointer", fontSize:15,
};
export const NT_BTN_PRIMARY = {
  padding:"8px 16px", borderRadius:9, border:"none",
  background:"#f59e0b", color:"white", fontSize:12,
  fontWeight:700, cursor:"pointer", fontFamily:"inherit",
};
export const NT_BTN_GHOST = {
  padding:"7px 13px", borderRadius:8,
  border:"1.5px solid #e5e7eb", background:"white",
  color:"#6b7280", fontSize:12, fontWeight:600,
  cursor:"pointer", fontFamily:"inherit",
